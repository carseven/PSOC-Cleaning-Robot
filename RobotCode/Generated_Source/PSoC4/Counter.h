...
#define Counter_TC_STOP_SIGNAL_MODE            (1lu)
#define Counter_TC_CAPTURE_SIGNAL_MODE         (1lu)

/* Signal present */
#define Counter_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define Counter_TC_COUNT_SIGNAL_PRESENT        (0lu)
#define Counter_TC_START_SIGNAL_PRESENT        (1lu)
#define Counter_TC_STOP_SIGNAL_PRESENT         (1lu)
#define Counter_TC_CAPTURE_SIGNAL_PRESENT      (1lu)

/* Interrupt Mask */
#define Counter_TC_INTERRUPT_MASK              (2lu)
...
#define Counter_PWM_OUT_N_INVERT               (1lu)
#define Counter_PWM_OUT_INVERT                 (1lu)
